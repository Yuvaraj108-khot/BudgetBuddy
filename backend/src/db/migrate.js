/**
 * Database Migration Script — CampusCash
 * Creates all tables with security fields included
 */
  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS users (
        ...
        -- App PIN lock (stored as bcrypt hash — never plain text)
        ...
        pin_locked_until       TIMESTAMP DEFAULT NULL,
    ...
    // ── 4. Audit Log Table ───────────────────────────────────────
    // Logs all security events: logins, pin failures, lockouts
    await client.query(`
